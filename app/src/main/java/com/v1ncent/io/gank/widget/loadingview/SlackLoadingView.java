package com.v1ncent.io.gank.widget.loadingview;
...
public class SlackLoadingView extends View {
    ...
    //线条最大长度
    private final int MAX_LINE_LENGTH = dp2px(getContext(), 500);
    //线条最短长度
    private final int MIN_LINE_LENGTH = dp2px(getContext(), 10);
    //最大间隔时长
    ...
    private int[] mColors = new int[]{getResources().getColor(R.color.tab_1)
            , getResources().getColor(R.color.tab_2)
            , getResources().getColor(R.color.tab_3)
            , getResources().getColor(R.color.tab_4)};
