...
public class ModuleIOSAdapter extends RecyclerView.Adapter<ModuleIOSAdapter.ModuleViewHolder> {
    private Context context;
    private List<DayDateResult.ResultsBean.IOSBean> detailsList;
    private int logoid[] = {
    ...
    public ModuleIOSAdapter(Context context, List<DayDateResult.ResultsBean.IOSBean> detailsList) {
    ...
    @Override
    public ModuleIOSAdapter.ModuleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_module, parent, false);
        return new ModuleIOSAdapter.ModuleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ModuleIOSAdapter.ModuleViewHolder holder, int position) {
        DayDateResult.ResultsBean.IOSBean details = detailsList.get(position);
