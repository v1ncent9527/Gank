...
public class ModuleVideoAdapter extends RecyclerView.Adapter<ModuleVideoAdapter.ModuleViewHolder> {
    private Context context;
    private List<DayDateResult.ResultsBean.休息视频Bean> detailsList;
    private int logoid[] = {
    ...
    public ModuleVideoAdapter(Context context, List<DayDateResult.ResultsBean.休息视频Bean> detailsList) {
        this.context = context;
        this.detailsList = detailsList;
    }

    @Override
    public ModuleVideoAdapter.ModuleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_module, parent, false);
        return new ModuleVideoAdapter.ModuleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ModuleVideoAdapter.ModuleViewHolder holder, int position) {
        DayDateResult.ResultsBean.休息视频Bean details = detailsList.get(position);
