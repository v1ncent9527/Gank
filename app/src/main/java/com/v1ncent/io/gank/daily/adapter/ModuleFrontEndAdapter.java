...
public class ModuleFrontEndAdapter extends RecyclerView.Adapter<ModuleFrontEndAdapter.ModuleViewHolder> {
    private Context context;
    private List<DayDateResult.ResultsBean.前端Bean> detailsList;
    private int logoid[] = {
    ...
    public ModuleFrontEndAdapter(Context context, List<DayDateResult.ResultsBean.前端Bean> detailsList) {
        this.context = context;
        this.detailsList = detailsList;
    }

    @Override
    public ModuleFrontEndAdapter.ModuleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_module, parent, false);
        return new ModuleFrontEndAdapter.ModuleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ModuleFrontEndAdapter.ModuleViewHolder holder, int position) {
        DayDateResult.ResultsBean.前端Bean details = detailsList.get(position);
