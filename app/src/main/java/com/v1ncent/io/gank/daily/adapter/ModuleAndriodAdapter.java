...
public class ModuleAndriodAdapter extends RecyclerView.Adapter<ModuleAndriodAdapter.ModuleViewHolder> {
    private Context context;
    private List<DayDateResult.ResultsBean.AndroidBean> detailsList;
    private int logoid[] = {
    ...
    public ModuleAndriodAdapter(Context context, List<DayDateResult.ResultsBean.AndroidBean> detailsList) {
        this.context = context;
        this.detailsList = detailsList;
    }

    @Override
    public ModuleAndriodAdapter.ModuleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_module, parent, false);
        return new ModuleAndriodAdapter.ModuleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ModuleAndriodAdapter.ModuleViewHolder holder, int position) {
        DayDateResult.ResultsBean.AndroidBean details = detailsList.get(position);
